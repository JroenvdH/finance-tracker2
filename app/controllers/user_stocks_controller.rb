class UserStocksController < ApplicationController
  ...
  def create
    if params[:stock_id].present?
      ...
      if stock
        ...
        if stock.save
          ...
          @user_stock = nil
          flash[:error] = "Sorry... The stock is not available"
        end
      end
    end
    ...
    respond_to do |format|
      if @user_stock.save
        ...
        notice: "#{@user_stock.stock.name} was successfully added to your portfolio" }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to my_portfolio_path,
                                notice: 'The stock has successfully been removed from your portfolio' }
